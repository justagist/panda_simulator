/***************************************************************************
* Adapted from electric_gripper_controller.cpp (sawyer_simulator package)
...
bool ElectricGripperController::init(panda_hardware_interface::SharedJointInterface* robot,
                                ros::NodeHandle &nh) {
...
PLUGINLIB_EXPORT_CLASS(panda_sim_controllers::ElectricGripperController,
