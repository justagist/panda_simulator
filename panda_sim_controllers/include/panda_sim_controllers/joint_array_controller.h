/***************************************************************************
* Adapted from joint_array_controller.h (sawyer_simulator package)
...
namespace panda_sim_controllers {
  ...
  class JointArrayController : public controller_interface::Controller<panda_hardware_interface::SharedJointInterface>
  {
  public:
   ...
   // virtual void setCommands(std::map<std::string, Command> cmds);
    ...
    //template <typename T>  // T = Joint(_)Controller
    virtual bool init(panda_hardware_interface::SharedJointInterface* robot, ros::NodeHandle& nh)
    {
      return init(robot, nh, "");
    }

    virtual bool init(panda_hardware_interface::SharedJointInterface* robot, ros::NodeHandle& nh, const std::string& ctrl_type)
    {
      return _initJointsControls(robot, nh, ctrl_type);
    }

    bool _initJointsControls(panda_hardware_interface::SharedJointInterface* robot, ros::NodeHandle& nh, const std::string& ctrl_type)
    {
