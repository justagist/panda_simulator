/***************************************************************************
* Adapted from electric_gripper_controller.h (sawyer_simulator package)
...
{
  class ElectricGripperController : public controller_interface::Controller<panda_hardware_interface::SharedJointInterface>
  {
